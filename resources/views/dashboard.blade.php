...
@section('content')
    ...
    <div class="row row-sm">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    ...
                                    <p class="mb-0 tx-12 text-white op-10">عدد الفواتير
                                        <br> {{ \App\Models\invoices::count() }}
                                    </p>
                                </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<a href="{{ url('/' . $page='invoices-unpaid') }}">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-10">عدد الفواتير
                                    <br> {{ \App\Models\invoices::where('Value_Status', 2)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-10">عدد الفواتير
                                    <br> {{ \App\Models\invoices::where('Value_Status', 1)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
			<a href="{{ url('/' . $page='invoices-partially') }}">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-10">عدد الفواتير
                                    <br> {{ \App\Models\invoices::where('Value_Status', 3)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
